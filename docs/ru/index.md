...
Проект находится на стадии **`0.6.0a2`** и распространяется под Apache-2.0. Платного облака, телеметрии и закрытых функций нет.

## Быстрый старт

Пока пакет не опубликован в PyPI, устанавливайте его напрямую из GitHub:
